...
public class TextCommonUtils {
     ...
     * @param spanUrlCallBack    链接点击的返回
     */
    public static void setUrlSmileText(Context context, String string, List<TwitterModel> listUser, ITextViewShow textView, int color, boolean needNum, SpanAtUserCallBack spanAtUserCallBack, SpanUrlCallBack spanUrlCallBack) {
     ...
     * @return 返回显示的spananle
     */
    public static Spannable getAtText(Context context, List<TwitterModel> listUser, List<TwitterModel> listTopic, String content, ITextViewShow textView, boolean clickable,
        ...
        for (int i = 0; i < listUser.size(); i++) {
            int index = content.indexOf("@" + listUser.get(i).getValue(), indexStart) + 1;
            if (index < 0 && indexStart > 0) {
                index = content.indexOf(listUser.get(i).getValue());
            ...
            if (index > 0) {
                ...
                int indexEnd = index + listUser.get(i).getValue().length();
     ...
     * @return Spannable
     */
    public static Spannable getTopicText(Context context, List<TwitterModel> listTopic, String content, ITextViewShow textView, boolean clickable,
        ...
        for (int i = 0; i < listTopic.size(); i++) {
            int index = content.indexOf("#" + listTopic.get(i).getValue() + "#", indexStart) + 1;
            if (index < 0 && indexStart > 0) {
                index = content.indexOf(listTopic.get(i).getValue());
                if (map.containsKey("" + index)) {
                    int tmpIndexStart = (indexStart < lenght) ? Integer.parseInt(map.get("" + index)) : lenght - 1;
                    if (tmpIndexStart != indexStart) {
                        indexStart = tmpIndexStart;
            ...
            if (index > 0) {
                map.put(index + "", index + "");
                int mathStart = index - 1;
                int indexEnd = index + listTopic.get(i).getValue().length();
     ...
     * @return 返回显示的spananle
     */
    public static Spannable getUrlSmileText(Context context, String string, List<TwitterModel> listUser, ITextViewShow textView, int colorAt, int colorLink, boolean needNum, SpanAtUserCallBack spanAtUserCallBack, SpanUrlCallBack spanUrlCallBack) {
     ...
     * @return 返回显示的spananle
     */
    public static Spannable getAllSpanText(Context context, String string, List<TwitterModel> listUser, List<TwitterModel> listTopic, ITextViewShow textView, int colorAt, int colorLink, int colorTopic, boolean needNum, boolean needUrl, SpanAtUserCallBack spanAtUserCallBack, SpanUrlCallBack spanUrlCallBack, SpanTopicCallBack spanTopicCallBack) {
        if (needUrl || needNum) {
